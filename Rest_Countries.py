...
print("\nEl País con mayor área:")
print(f"{max_area_country[0]} con {max_area_country[1]} km²")

print("\nLa Población total:", total_population)
print("La Media de la población:", mean_population)
print("La Mediana de la población:", median_population)
print("La Moda Población:", mode_population)